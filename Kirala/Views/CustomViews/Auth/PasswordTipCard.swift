...
final class PasswordTipCard: UIView {
    ...
    private lazy var tipLabel1: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = Strings.Auth.forgotPasswordTip1.localized
    ...
    private lazy var tipLabel2: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = Strings.Auth.forgotPasswordTip2.localized
        label.font = UIFont.systemFont(ofSize: 11)
        label.textColor = ColorPalette.gray.dynamicColor
        label.numberOfLines = 0
        return label
    ...
    private lazy var tipLabel3: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = Strings.Auth.forgotPasswordTip3.localized
        label.font = UIFont.systemFont(ofSize: 11)
        label.textColor = ColorPalette.gray.dynamicColor
        label.numberOfLines = 0
        return label
