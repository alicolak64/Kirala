...
extension UIDevice {
    ...
    /// Returns the current OS name of the device.
    ...
    /// Returns the screen height based on the current orientation.
    ...
    /// Returns the screen width based on the current orientation.
    ...
    /// Determines the orientation type of the device.
